...
export const PerfilUsuario = () => {
    const { user, form, loading, saving, deleting, error, success, handleChange, handleSubmit, handleDelete } = usePerfilUsuario()
                ...
                <div className="perfil-card">
                    <div className="perfil-card__header">
                        <div>
                            ...
                            <p className="perfil-card__subtitle">Visualize e edite suas informações</p>
                        </div>
                        {!loading && !editing && (
                            <button
                    ...
                    {loading ? (
                        ...
                        <form className="perfil-form" onSubmit={onSubmit} noValidate>
                            <div className="perfil-form__field">
                                <label className="perfil-form__label" htmlFor="name">Nome completo</label>
                                <input
                            ...
                            <div className="perfil-form__field">
                                <label className="perfil-form__label" htmlFor="email">E-mail</label>
                                <input
                                    className="perfil-form__input"
                                    id="email"
                                    name="email"
                            ...
                            <div className="perfil-form__field">
                                <label className="perfil-form__label" htmlFor="telefone">
                                    Telefone <span className="perfil-form__optional">(opcional)</span>
                                </label>
                                <input
                                    className="perfil-form__input"
                                    id="telefone"
                        ...
                        <div className="perfil-info">
                            {success && <p className="perfil-form__success">Perfil atualizado com sucesso!</p>}
                            ...
                            <div className="perfil-info__field">
                                ...
                                <p className="perfil-info__value">{user?.telefone ?? <span className="perfil-info__empty">Não informado</span>}</p>
                            </div>
                            ...
                            {!confirmDelete ? (
                                ...
                                <div className="perfil-confirm">
                                    <p className="perfil-confirm__text">Tem certeza? Essa ação é irreversível.</p>
